...
GRANT SELECT, UPDATE, INSERT ON TRANG_THAI_DON_HANG TO TAI_XE
...
GRANT UPDATE ON UV_TTDOITAC(TEN_DOI_TAC, NGUOI_DAI_DIEN, SDT, EMAIL, DUONG, PHUONG, QUAN, THANH_PHO) TO TAI_XE
...
AS
SELECT KH.MATK, HO_TEN, SDT, EMAIL, DUONG, PHUONG, QUAN, THANH_PHO
FROM KHACH_HANG KH JOIN TAI_KHOAN TK ON KH.MATK = TK.MATK
WHERE TK.TENTK = CURRENT_USER --CURRENT_USER LÀ TÀI KHOẢN ĐANG ĐĂNG NHẬP 
GO
