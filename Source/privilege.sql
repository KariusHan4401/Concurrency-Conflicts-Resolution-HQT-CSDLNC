...
GRANT UPDATE ON UV_TTDOITAC(TEN_DOI_TAC, NGUOI_DAI_DIEN, SDT, EMAIL, DUONG, PHUONG, QUAN, THANH_PHO, QUAN_NDD, TP_NDD) TO DOI_TAC
...
GRANT UPDATE ON UV_SPDOITAC(TENSP, MO_TA, DUONG, PHUONG, QUAN, THANH_PHO) TO DOI_TAC
